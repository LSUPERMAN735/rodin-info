...
{
    public class ConseilDeLectureSection : Section<HtmlSchema>
    {
		private HtmlDataProvider _dataProvider;	

		public ConseilDeLectureSection()
		{
		...
		public override async Task<IEnumerable<HtmlSchema>> GetDataAsync(SchemaBase connectedItem = null)
        {
            ...
            {
                FilePath = "/Assets/Data/ConseilDeLecture.htm"
            };
        ...
        public override ListPageConfig<HtmlSchema> ListPage
        {
            get 
            {
                ...
                {
                    Title = "conseil de lecture",

                    Page = typeof(Pages.ConseilDeLectureListPage),
