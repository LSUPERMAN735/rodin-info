...
{
    public class VUEDELACITESCOLAIRESection : Section<HtmlSchema>
    {
		...
		public override async Task<IEnumerable<HtmlSchema>> GetDataAsync(SchemaBase connectedItem = null)
        {
            ...
            {
                FilePath = "/Assets/Data/VUEDELACITESCOLAIRE.htm"
            };
        ...
        public override ListPageConfig<HtmlSchema> ListPage
        {
            get 
            {
                ...
                {
                    Title = "VUE DE LA CITE SCOLAIRE",

                    Page = typeof(Pages.VUEDELACITESCOLAIREListPage),
