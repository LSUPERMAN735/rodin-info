...
{
    public class AnglaisEtSectionEuropeenneSection : Section<HtmlSchema>
    {
        ...
        public override ListPageConfig<HtmlSchema> ListPage
        {
            get 
            {
                ...
                {
                    Title = "Anglais et section européenne",

                    Page = typeof(Pages.AnglaisEtSectionEuropeenneListPage),
