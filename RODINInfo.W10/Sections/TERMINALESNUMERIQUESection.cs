...
{
    public class TERMINALESNUMERIQUESection : Section<HtmlSchema>
    {
		...
		public override async Task<IEnumerable<HtmlSchema>> GetDataAsync(SchemaBase connectedItem = null)
        {
            ...
            {
                FilePath = "/Assets/Data/TERMINALESNUMERIQUE.htm"
            };
        ...
        public override ListPageConfig<HtmlSchema> ListPage
        {
            get 
            {
                ...
                {
                    Title = "TERMINALE S NUMERIQUE",

                    Page = typeof(Pages.TERMINALESNUMERIQUEListPage),
