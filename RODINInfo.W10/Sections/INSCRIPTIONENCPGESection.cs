...
{
    public class INSCRIPTIONENCPGESection : Section<HtmlSchema>
    {
		private HtmlDataProvider _dataProvider;	

		public INSCRIPTIONENCPGESection()
		{
		...
		public override async Task<IEnumerable<HtmlSchema>> GetDataAsync(SchemaBase connectedItem = null)
        {
            ...
            {
                FilePath = "/Assets/Data/INSCRIPTIONENCPGE.htm"
            };
        ...
        public override ListPageConfig<HtmlSchema> ListPage
        {
            get 
            {
                ...
                {
                    Title = "INSCRIPTION EN CPGE",

                    Page = typeof(Pages.INSCRIPTIONENCPGEListPage),
