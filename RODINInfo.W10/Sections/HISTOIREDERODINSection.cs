...
{
    public class HISTOIREDERODINSection : Section<HtmlSchema>
    {
		...
		public override async Task<IEnumerable<HtmlSchema>> GetDataAsync(SchemaBase connectedItem = null)
        {
            ...
            {
                FilePath = "/Assets/Data/HISTOIREDERODIN.htm"
            };
        ...
        public override ListPageConfig<HtmlSchema> ListPage
        {
            get 
            {
                ...
                {
                    Title = "HISTOIRE DE RODIN",

                    Page = typeof(Pages.HISTOIREDERODINListPage),
