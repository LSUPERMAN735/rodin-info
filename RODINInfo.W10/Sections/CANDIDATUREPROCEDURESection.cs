...
{
    public class CANDIDATUREPROCEDURESection : Section<HtmlSchema>
    {
		...
		public override async Task<IEnumerable<HtmlSchema>> GetDataAsync(SchemaBase connectedItem = null)
        {
            ...
            {
                FilePath = "/Assets/Data/CANDIDATUREPROCEDURE.htm"
            };
        ...
        public override ListPageConfig<HtmlSchema> ListPage
        {
            get 
            {
                ...
                {
                    Title = "CANDIDATURE PROCEDURE",

                    Page = typeof(Pages.CANDIDATUREPROCEDUREListPage),
