...
{
    public class TEMINALEESMATHSSection : Section<HtmlSchema>
    {
		private HtmlDataProvider _dataProvider;	

		public TEMINALEESMATHSSection()
		{
		...
		public override async Task<IEnumerable<HtmlSchema>> GetDataAsync(SchemaBase connectedItem = null)
        {
            ...
            {
                FilePath = "/Assets/Data/TEMINALEESMATHS.htm"
            };
        ...
        public override ListPageConfig<HtmlSchema> ListPage
        {
            get 
            {
                ...
                {
                    Title = "TEMINALE ES MATHS",

                    Page = typeof(Pages.TEMINALEESMATHSListPage),
