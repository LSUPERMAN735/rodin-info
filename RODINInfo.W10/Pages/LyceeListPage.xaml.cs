//---------------------------------------------------------------------------
//
// <copyright file="LyceeListPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class LyceeListPage : Page
    {
	    public ListViewModel ViewModel { get; set; }
        public LyceeListPage()
        {
			ViewModel = ViewModelFactory.NewList(new LyceeSection());
