//---------------------------------------------------------------------------
//
// <copyright file="UTILESDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class UTILESDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public UTILESDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new UTILESSection());
